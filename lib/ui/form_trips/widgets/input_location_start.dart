  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(15), // Bordes redondeados (12 píxeles de radio)  
      ),
      child: Row(
        children: [
          ...
          Expanded(
            child: TextField(
              ...
              onTap: onTap,
              readOnly: readOnly,
              style: const TextStyle(color: Color.fromRGBO(255, 255, 255, 1), fontSize: 18), // Estilo del texto ingresado en el input
              decoration: InputDecoration(
                hintText: hintText,
                hintStyle: TextStyle(
                  color: Colors.white.withValues(alpha: 0.6),
                  fontSize: 18, // Tamaño del texto del placeholder (Ej: "Ubicación de inicio")
                ),
